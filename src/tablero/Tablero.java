...
//		}
	...
	public boolean ubicarProaDeNave(Nave unaNave, Casillero unCasillero) {
		 ...
		 * que tiene la nave podemos saber que casilleros va a ocupar. Si no
		 * entra supongo que habr�a que levantar una excepcion, o redefinir la
		 * firma de la funcion a bool..
		 */
		...
		// for(SeccionDeNave unaSeccionDeNave : unaNave){ //no se porque tira
		// error con SeccionesDeNave en vez de object
